...
ActiveRecord::Schema[7.1].define(version: 2026_03_30_171814) do
  ...
  create_table "conversation_pinned_messages", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "conversation_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "conversation_id"], name: "index_conversation_pinned_messages_on_account_and_conversation"
    t.index ["account_id"], name: "index_conversation_pinned_messages_on_account_id"
    t.index ["conversation_id", "message_id"], name: "index_conversation_pinned_messages_on_conv_and_message", unique: true
    t.index ["conversation_id"], name: "index_conversation_pinned_messages_on_conversation_id"
    t.index ["message_id"], name: "index_conversation_pinned_messages_on_message_id"
    t.index ["pinned_by_id"], name: "index_conversation_pinned_messages_on_pinned_by_id"
  end
  ...
  create_table "pinned_messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_pinned_messages_on_account_id"
    t.index ["conversation_id", "message_id"], name: "index_pinned_messages_on_conversation_id_and_message_id", unique: true
  end
  ...
  add_foreign_key "conversation_pinned_messages", "accounts"
  add_foreign_key "conversation_pinned_messages", "conversations"
  add_foreign_key "conversation_pinned_messages", "messages"
  add_foreign_key "conversation_pinned_messages", "users", column: "pinned_by_id"
  add_foreign_key "inboxes", "portals"
  add_foreign_key "pinned_messages", "accounts"
  add_foreign_key "pinned_messages", "conversations"
